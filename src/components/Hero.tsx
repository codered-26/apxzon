...
const Hero: React.FC = () => {
  return (
    <section id="home" className="relative min-h-[90dvh] md:min-h-screen flex items-center pt-20 pb-12 sm:pb-0 overflow-hidden bg-dot-grid [mask-image:radial-gradient(ellipse_at_center,black_70%,transparent_100%)]">
          ...
          >
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center px-4 sm:px-0">
              ...
              <motion.button
                ...
                className="px-6 py-3.5 sm:px-8 sm:py-4 rounded-4xl bg-foreground/5 text-foreground font-bold backdrop-blur-md border border-foreground/10 flex items-center justify-center gap-2 hover:bg-foreground/10 transition-all"
              >
                Explore Services
